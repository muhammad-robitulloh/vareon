...
import ChatInterfaceTab from '@/pages/Dashboard/client/src/components/arcana/chat-interface-tab';
import TerminalTab from '@/pages/Dashboard/client/src/components/arcana/terminal-tab';
