...
import SearchEngineTab from '@/pages/Dashboard/client/src/components/neosyntis/search-engine-tab';
import DatasetTab from '@/pages/Dashboard/client/src/components/neosyntis/dataset-tab';
import WorkflowBuilderTab from '@/pages/Dashboard/client/src/components/neosyntis/workflow-builder-tab';
import TelemetryTab from '@/pages/Dashboard/client/src/components/neosyntis/telemetry-tab';
import DeviceSettingsTab from '@/pages/Dashboard/client/src/components/neosyntis/device-settings-tab';
import CognisysConfigTab from '@/pages/Dashboard/client/src/components/neosyntis/cognisys-config-tab';
import EcosystemBuilderTab from '@/pages/Dashboard/client/src/components/neosyntis/ecosystem-builder-tab';
import ModelDeploymentTab from '@/pages/Dashboard/client/src/components/neosyntis/model-deployment-tab';
import MachineLearningTab from '@/pages/Dashboard/client/src/components/neosyntis/machine-learning-tab';
...
export default function Neosyntis() {
  ...
  const handleTabChange = (newTab: string) => {
    setActiveTab(newTab);
    setLocation(`/neosyntis?tab=${newTab}`);
  };
