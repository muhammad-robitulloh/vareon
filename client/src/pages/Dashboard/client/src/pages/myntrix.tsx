...
import AgentManagerTab from '@/pages/Dashboard/client/src/components/myntrix/agent-manager-tab';
import TaskSchedulerTab from '@/pages/Dashboard/client/src/components/myntrix/task-scheduler-tab';
import DeviceControlTab from '@/pages/Dashboard/client/src/components/myntrix/device-control-tab';
import ResourceMonitorTab from '@/pages/Dashboard/client/src/components/myntrix/resource-monitor-tab';
...
export default function Myntrix() {
  ...
  const handleTabChange = (newTab: string) => {
    setActiveTab(newTab);
    setLocation(`/myntrix?tab=${newTab}`);
  };
