...
export default function NeuroNetCapabilities() {
  return (
    <div className="bg-background py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16 text-center">
          <h2 className="mb-4 text-4xl font-bold text-foreground">
            NeuroNet AI Capabilities
          </h2>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {capabilities.map((capability) => (
            <Card key={capability.title} className="group border border-card-border p-6 hover-elevate">
        ...
        <div className="mt-16 rounded-2xl border border-primary/20 bg-primary/10 p-8">
          <div className="text-center">
            ...
            <p className="mx-auto max-w-3xl text-muted-foreground">
              The original NeuroNet system has been seamlessly integrated into MYNTRIX Core through a dedicated adapter layer.
